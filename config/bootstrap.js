...
module.exports.bootstrap = async function() {
  ...
  await Thing.createEach([
    { label:"big new thing", Owner: ryanDahl.id},
    { label:"small new thing", Owner: mikeMcNeil.id},
    { label:"big old thing", Owner: ryanDahl.id},
    { label:"small old thing", Owner: mikeMcNeil.id},
    { label:"Amazing thing", Owner: mikeMcNeil.id},
    { label:"Not so amaizing thing", Owner: mikeMcNeil.id},
  ]);

  // //Add ryan dahl to mikes friends
  await User.addToCollection(mikeMcNeil.id, 'friends', ryanDahl.id);
  // //Add mike to ryans friends
